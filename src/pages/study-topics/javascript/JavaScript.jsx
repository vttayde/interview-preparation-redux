...
const JavaScript = () => {
    const [activeTab, setActiveTab] = useState(JAVASCRIPT_TABS[0]?.id || 'default');
    ...
    const tabs = JAVASCRIPT_TABS;

    const renderTabContent = () => {
        const content = JAVASCRIPT_CONTENT[activeTab] || JAVASCRIPT_CONTENT.default;
        return (
    ...
    return (
        <div className="bg-white shadow rounded-lg p-6">
            <div className="border-b border-gray-200 pb-4 mb-6">
                <h1 className="text-3xl font-bold text-gray-900">{JAVASCRIPT_UI_TEXT.title}</h1>
                <p className="mt-2 text-gray-600">{JAVASCRIPT_UI_TEXT.description}</p>
            </div>
