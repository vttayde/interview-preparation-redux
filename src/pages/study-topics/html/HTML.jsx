                    ...
                    <div className="space-y-6">
                        <section>
                            ...
                            <p className="text-gray-600 mb-4">
                                ...
                                It describes the structure and content of web pages using elements and tags that tell browsers how to display content.
                            </p>
                        </section>
                        ...
                        <section>
                            ...
                            <div className="space-y-6">
                                <div className="bg-blue-50 p-6 rounded-lg">
                                    <h4 className="font-semibold text-blue-800 mb-3 text-lg">🏷️ Elements & Tags</h4>
...
<em>Italic text</em>`}
                                ...
                                <div className="bg-green-50 p-6 rounded-lg">
                                    <h4 className="font-semibold text-green-800 mb-3 text-lg">📄 Document Structure</h4>
...
<body>
    ...
    <footer>Footer</footer>
                                ...
                                <div className="bg-purple-50 p-6 rounded-lg">
                                    <h4 className="font-semibold text-purple-800 mb-3 text-lg">🎯 Attributes</h4>
...
<div data-user-id="123" data-role="admin">`}
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Block vs Inline Elements</h3>
            ...
            case 'semantic':
                return (
                    <div className="space-y-6">
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Semantic HTML</h2>
                            <p className="text-gray-600 mb-4">
                                Semantic HTML uses elements that clearly describe their meaning and purpose, making content more accessible to both browsers and assistive technologies.
                            </p>
                        </section>

                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">HTML5 Semantic Elements</h3>
                            <div className="space-y-4">
                                <div className="bg-blue-50 p-6 rounded-lg">
                                    <h4 className="font-semibold text-blue-800 mb-3">Document Structure Elements</h4>
                                ...
                                <div className="bg-green-50 p-6 rounded-lg">
                                    <h4 className="font-semibold text-green-800 mb-3">Content Elements</h4>
                                    <div className="bg-green-100 p-3 rounded text-xs">
...
<samp>Sample output</samp>`}
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Semantic Page Structure</h3>
                            <div className="bg-gray-50 p-4 rounded-lg">
        ...
        <p>&copy; 2024 Website Name</p>
            ...
            case 'forms':
                return (
                    <div className="space-y-6">
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-800 mb-4">HTML Forms & Input</h2>
                            <p className="text-gray-600 mb-4">
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Form Structure</h3>
                            <div className="bg-blue-50 p-6 rounded-lg">
                                <h4 className="font-semibold text-blue-800 mb-3">Basic Form Elements</h4>
                                <div className="bg-blue-100 p-3 rounded text-xs">
...
{`<form action="/submit" method="POST" enctype="multipart/form-data">
    <fieldset>
        ...
        <button type="reset">Reset</button>
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">HTML5 Input Types</h3>
                            <div className="grid md:grid-cols-2 gap-4">
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Form Validation</h3>
                            <div className="bg-red-50 p-6 rounded-lg">
                                <h4 className="font-semibold text-red-800 mb-3">HTML5 Validation Attributes</h4>
    ...
    <input type="email" name="email">
            ...
            case 'accessibility':
                return (
                    <div className="space-y-6">
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-800 mb-4">HTML Accessibility</h2>
                            <p className="text-gray-600 mb-4">
                        ...
                        <section>
                            ...
                            <div className="space-y-4">
                                <div className="bg-blue-50 p-6 rounded-lg">
                                    <h4 className="font-semibold text-blue-800 mb-3">Core ARIA Attributes</h4>
                                    <div className="bg-blue-100 p-3 rounded text-xs">
                                        <pre className="text-blue-800">
...
<div role="tabpanel" id="panel1" aria-labelledby="tab1">`}
                                ...
                                <div className="bg-green-50 p-6 rounded-lg">
                                    <h4 className="font-semibold text-green-800 mb-3">Semantic HTML for Accessibility</h4>
                                    <div className="bg-green-100 p-3 rounded text-xs">
                                        <pre className="text-green-800">
        ...
        <tr>
            ...
            <th scope="col">Price</th>
                        ...
                        <section>
                            ...
                            <div className="bg-purple-50 p-6 rounded-lg">
                                <h4 className="font-semibold text-purple-800 mb-3">Focus Management</h4>
                                <div className="bg-purple-100 p-3 rounded text-xs">
...
<div role="button" tabindex="0" 
    ...
    Custom Button
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Accessibility Best Practices</h3>
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="bg-gray-50 p-4 rounded-lg">
            ...
            case 'examples':
                return (
                    <div className="space-y-6">
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-800 mb-4">HTML Code Examples</h2>
                            <p className="text-gray-600 mb-4">
                                Practical examples demonstrating common HTML patterns and best practices for building modern web pages.
                            </p>
                        </section>

                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Complete Page Example</h3>
                            <div className="bg-gray-50 p-4 rounded-lg">
...
<body>
    ...
    <footer>
        ...
        <p>&copy; 2024 Your Company. All rights reserved.</p>
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Contact Form Example</h3>
                            <div className="bg-green-50 p-4 rounded-lg">
    ...
    <fieldset>
        ...
        <div class="form-actions">
            ...
            <button type="reset" class="reset-btn">Clear Form</button>
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Data Table Example</h3>
                            <div className="bg-blue-50 p-4 rounded-lg">
                                <pre className="text-sm text-blue-800 overflow-x-auto">
{`<table class="data-table" role="table" aria-label="Employee Information">
        ...
        <tr>
            ...
            case 'interview':
                return (
                    <div className="space-y-6">
                        <section>
                            <h2 className="text-2xl font-semibold text-gray-800 mb-4">HTML Interview Questions</h2>
                            <p className="text-gray-600 mb-4">
                                Common HTML interview questions and comprehensive answers to help you prepare for frontend developer interviews.
                            </p>
                        </section>
                            ...
                            <div className="space-y-4">
                                ...
                                <details className="bg-purple-50 p-4 rounded-lg">
                                    <summary className="font-semibold text-purple-800 cursor-pointer mb-2">
                                        Explain the HTML5 DOCTYPE declaration
                                    </summary>
                            ...
                            <div className="space-y-4">
                                ...
                                <details className="bg-yellow-50 p-4 rounded-lg">
                                    <summary className="font-semibold text-yellow-800 cursor-pointer mb-2">
                                        What are Web Components and how do they relate to HTML?
                                    </summary>
                        ...
                        <section>
                            <h3 className="text-xl font-semibold text-gray-800 mb-3">Practical Coding Questions</h3>
                            <div className="bg-gray-50 p-4 rounded-lg">
                                <h4 className="font-semibold text-gray-800 mb-2">Common Coding Challenges:</h4>
                                <ul className="text-sm text-gray-600 space-y-2">
                                    <li>• Create a responsive navigation menu using semantic HTML</li>
                                    <li>• Build an accessible contact form with proper validation</li>
                                    <li>• Structure a blog post with proper heading hierarchy</li>
                                    <li>• Implement a data table with sorting capabilities</li>
                                    <li>• Create a modal dialog with proper focus management</li>
                                    <li>• Build a product card component with all necessary elements</li>
                                </ul>
                            </div>
                        </section>
                    </div>
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            <div className="max-w-6xl mx-auto px-4 py-8">
                <div className="mb-8">
                    <h1 className="text-4xl font-bold text-gray-900 mb-2">HTML Study Guide</h1>
                    <p className="text-xl text-gray-600">Master HTML fundamentals, semantic markup, and modern best practices</p>
                </div>
