...
const ReactJS = () => {
    const [activeTab, setActiveTab] = useState(REACT_TABS[0]?.id || 'default');
    ...
    const tabs = REACT_TABS;

    const renderTabContent = () => {
        const content = REACT_CONTENT[activeTab] || REACT_CONTENT.default;
        return (
    ...
    return (
        <div className="bg-white shadow rounded-lg p-6">
            <div className="border-b border-gray-200 pb-4 mb-6">
                <h1 className="text-3xl font-bold text-gray-900">{REACT_UI_TEXT.title}</h1>
                <p className="mt-2 text-gray-600">{REACT_UI_TEXT.description}</p>
            </div>
