...
const Introduction = () => {
  ...
  const renderTabContent = () => {
    const content = INTRODUCTION_CONTENT[activeTab] || INTRODUCTION_CONTENT.default;
    return (
  ...
  return (
    <div className="bg-white shadow rounded-lg p-6">
      <div className="border-b border-gray-200 pb-4 mb-6">
        <h1 className="text-3xl font-bold text-gray-900">{INTRODUCTION_UI_TEXT.title}</h1>
        <p className="mt-2 text-gray-600">{INTRODUCTION_UI_TEXT.description}</p>
      </div>
